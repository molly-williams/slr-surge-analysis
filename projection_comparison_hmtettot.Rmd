...
# Compare future models to historical (using daily max values)

cor.test(max_hist_combined$HMETTOTmax, max_2030_combined$HMETTOTmax, method="kendall") # tau= 0.006, z = 3.7583, p=0.0001711

cor.test(max_hist_combined$HMETTOTmax, max_2050_combined$HMETTOTmax, method="kendall") # tau = 0.0096, z = 6.02, p<0.000001

cor.test(max_hist_combined$HMETTOTmax, max_2085_combined$HMETTOTmax, method="kendall") # not running because the HMETOTTmax values have different lengths; 2085 model is missing one value for each model (16 total)? WHY



# Compare future models to historical (annual max values)

cor.test(max_hist_combined_annual$HMETTOTmax, max_2030_combined_annual$HMETTOTmax, method="kendall") 

cor.test(max_hist_combined_annual$HMETTOTmax, max_2050_combined_annual$HMETTOTmax, method="kendall") 

cor.test(max_hist_combined_annual$HMETTOTmax, max_2085_combined_annual$HMETTOTmax, method="kendall") 
